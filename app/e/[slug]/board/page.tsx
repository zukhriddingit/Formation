    ...
    <main className="min-h-screen px-6 py-6 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-7xl">
        ...
        <header className="py-10">
          ...
          <h1 className="mt-5 text-4xl font-black text-white sm:text-6xl">{board.event.name} team board</h1>
          <p className="mt-4 max-w-2xl text-lg leading-8 text-zinc-300">
            Track participants, ideas, and forming teams as people find the right fit.
          </p>
        </header>

        <section className="mb-8 grid gap-4 md:grid-cols-3">
          <StatCard label="Players" value={stats.players} detail={`${stats.looking} free agents`} icon={Radio} />
          <StatCard label="Teams" value={stats.clubs} detail={`${stats.openPositions} open positions`} icon={Radio} />
